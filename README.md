...
Hot Bunnies is an idiomatic (J)Ruby DSL on top of the RabbitMQ Java client. It strives to combine
storng parts of the Java client with over 3 years of Ruby amqp gem development experience.
 ...
 * It uses synchronous APIs where it makes sense and asynchronous APIs where it makes sense. Some other Ruby clients
   only use one or the other.
 * amqp gem has certain amount of baggage it cannot drop because of backwards compatibility concerns. Hot Bunnies is a
